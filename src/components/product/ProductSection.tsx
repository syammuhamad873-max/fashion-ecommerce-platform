  ...
  return (
    <section className="space-y-6">
      <div className="flex items-end justify-between gap-4">
        ...
        <a href="#top" className="group inline-flex shrink-0 items-center gap-2 text-sm font-semibold text-neutral-700 hover:text-neutral-950">View all <Icon name="arrow" className="size-4 transition-transform group-hover:translate-x-1" /></a>
      </div>
